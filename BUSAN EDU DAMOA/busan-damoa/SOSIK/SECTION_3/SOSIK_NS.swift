...
// 진로도움방
class SOSIK_NS: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        UIViewController.APPDELEGATE.SOSIK_NS_VC = self
    ...
    @objc func NETWORK_CHECK() {
        ...
        if SYSTEM_NETWORK_CHECKING() {
            GET_POST_DATA(NAME: "학교뉴스", BOARD_TYPE: BOARD_TYPE, LIMIT_START: 0)
        } else {
    ...
    func GET_POST_DATA(NAME: String, BOARD_TYPE: String, LIMIT_START: Int) {
        ...
        UIViewController.USER_DATA.set(0, forKey: "PUSH_NS")
    ...
    func BEGINBATCHFETCH() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now(), execute: {
            ...
            if self.SYSTEM_NETWORK_CHECKING() {
                self.GET_POST_DATA(NAME: "학교뉴스", BOARD_TYPE: self.BOARD_TYPE, LIMIT_START: self.PAGE_NUMBER * self.ITEM_COUNT)
            } else {
...
extension SOSIK_NS: UITableViewDelegate, UITableViewDataSource {
