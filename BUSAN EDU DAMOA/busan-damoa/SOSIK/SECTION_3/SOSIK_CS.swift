...
// 행사체험
class SOSIK_CS: UIViewController {
    ...
    override func loadView() {
        ...
        UIViewController.APPDELEGATE.CS_CHECK = false
    ...
    override func viewDidLoad() {
        ...
        PUSH_BADGE(BOARD_TYPE: "CS", false)
        ...
        WKWEBVIEW_1.load(URLRequest(url: URL(string: "https://home.pen.go.kr/yeyak/exprn/selectDamoaExprnList.do")!))
        // 평생교육
        ...
        WKWEBVIEW_2.load(URLRequest(url: URL(string: "https://home.pen.go.kr/yeyak/pblprfr/selectDamoaPblprfrList.do")!))
    }
}

extension SOSIK_CS: WKUIDelegate, WKNavigationDelegate {
    ...
    func webView(_ webView: WKWebView, decidePolicyFor navigationAction: WKNavigationAction, decisionHandler: @escaping (WKNavigationActionPolicy) -> Void) {
        ...
        webView.evaluateJavaScript("document.documentElement.outerHTML") { (value, error) in
            ...
            let INFO_1 = "\(navigationAction.request)".contains("selectExprnInfo")
            let INFO_2 = "\(navigationAction.request)".contains("selectPblprfrInfo")
            ...
            if navigationAction.navigationType == .formSubmitted && (INFO_1 || INFO_2) {
                ...
                if webView == self.WKWEBVIEW_1 { VC.TITLE = "행사체험(견학체험)" } else { VC.TITLE = "행사체험(공연행사)" }
