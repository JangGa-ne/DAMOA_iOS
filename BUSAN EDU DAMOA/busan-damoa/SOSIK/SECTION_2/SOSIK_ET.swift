...
// 진로도움방
class SOSIK_ET: UIViewController {
    ...
    @IBAction func HOME_PAGE(_ sender: UIButton) { UIApplication.shared.open(URL(string: "https://dream.pen.go.kr")!) }
    
    var SOSIK_LIST: [SOSIK_API] = []
    var SOSIK_LIST_2: [SOSIK_API] = []
    
    var BOARD_TYPE: String = "ETN"
    ...
    // 공지사항
    @IBOutlet weak var TAB_1_BG: UIView!
    @IBOutlet weak var TAB_1_IMAGE: UIImageView!
    @IBOutlet weak var TAB_1: UIButton!
    @IBAction func TAB_1(_ sender: UIButton) {
        ...
        UIView.animate(withDuration: 0.2, animations: {
            ...
            self.TAB_2_BG.backgroundColor = .GRAY_F1F1F1
            self.TAB_2_IMAGE.image = UIImage(named: "menu_round_off.png")
            
            self.TAB_1_BG.backgroundColor = .systemTeal
            self.TAB_1_IMAGE.image = UIImage(named: "menu_round.png")
        })
    }
    
    // 대입공감똑똑,톡
    @IBOutlet weak var TAB_2_BG: UIView!
    @IBOutlet weak var TAB_2_IMAGE: UIImageView!
    @IBOutlet weak var TAB_2: UIButton!
    @IBAction func TAB_2(_ sender: UIButton) {
        ...
        UIView.animate(withDuration: 0.2, animations: {
            ...
            self.TAB_2_BG.backgroundColor = .systemTeal
            self.TAB_2_IMAGE.image = UIImage(named: "menu_round.png")
            
            self.TAB_1_BG.backgroundColor = .GRAY_F1F1F1
            self.TAB_1_IMAGE.image = UIImage(named: "menu_round_off.png")
        })
    }
    ...
    override func viewDidLoad() {
        ...
        UIViewController.APPDELEGATE.SOSIK_ET_VC = self
    ...
    @objc func NETWORK_CHECK() {
        ...
        if SYSTEM_NETWORK_CHECKING() {
            GET_POST_DATA(NAME: "진로도움방", BOARD_TYPE: BOARD_TYPE, LIMIT_START: 0)
        } else {
    ...
    func GET_POST_DATA(NAME: String, BOARD_TYPE: String, LIMIT_START: Int) {
        ...
        UIViewController.USER_DATA.set(0, forKey: "PUSH_ET")
    ...
    func BEGINBATCHFETCH() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now(), execute: {
            ...
            if self.SYSTEM_NETWORK_CHECKING() {
                self.GET_POST_DATA(NAME: "진로도움방", BOARD_TYPE: self.BOARD_TYPE, LIMIT_START: self.PAGE_NUMBER * self.ITEM_COUNT)
            } else {
...
extension SOSIK_ET: UITableViewDelegate, UITableViewDataSource {
