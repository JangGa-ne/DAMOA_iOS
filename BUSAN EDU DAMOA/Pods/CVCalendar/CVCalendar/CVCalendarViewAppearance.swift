...
public final class CVCalendarViewAppearance: NSObject {
    ...
    public var dayLabelWeekdayFont: UIFont? = UIFont(name: "YiSunShinDotumM", size: 16)
    public var dayLabelPresentWeekdayFont: UIFont? = UIFont(name: "YiSunShinDotumM", size: 16)
    public var dayLabelPresentWeekdayBoldFont: UIFont? = UIFont(name: "YiSunShinDotumM", size: 16)
    public var dayLabelPresentWeekdayHighlightedFont: UIFont? =
        UIFont(name: "YiSunShinDotumM", size: 16)
    public var dayLabelPresentWeekdaySelectedFont: UIFont? = UIFont(name: "YiSunShinDotumM", size: 16)
    public var dayLabelWeekdayHighlightedFont: UIFont? = UIFont(name: "YiSunShinDotumM", size: 16)
    public var dayLabelWeekdaySelectedFont: UIFont? = UIFont(name: "YiSunShinDotumM", size: 16)
    ...
    public var dayLabelPresentWeekdaySelectedBackgroundColor: UIColor? = .colorFromCode(0x007AFF)
